...
void Logger::log(const std::string& tag, const char* funcName,
                 const char* sourceFile, unsigned int lineNum, const std::string& fmt, ...) {
...
void Logger::fillOutputBuffer(std::string& outputBuffer, const std::string& tag,
                              const std::string& msg,	const char* funcName, const char* sourceFile,
...
void Logger::fillFileBuffer(std::string& outputBuffer, const std::string& tag,
                            const std::string& msg, const char* funcName, const char* sourceFile,
                            unsigned int lineNum) {
...
FILE* Logger::loadFileStream(FILE* stream, const char* filename) {
	...
	// If we couldn't create a new file stream just use the old one
	if(newStream == NULL) {
